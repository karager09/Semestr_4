...
#  To run:     ./lab_4b
#
#otwieramy plik instejacy, wczytujemy jako zawartość, zamykamy, wyświetlamy komunikat , zawartość i mówimy że OK, kończymy
#
#
#----------------------------------------------------------------
	...
	.equ	read_64,	0x00	# read data from file function, zwraca ile udało się przetworzyć(z ograniczeniem)
...
buffer:				# buffer for file data
	.space		128, 0	#pamięć bufora, i wartość 0 zeruje na bufor
